...
//const uri = Meteor.isProduction ? process.env.MONGO_URL : 'mongodb://127.0.0.1:3001/meteor'

const uri = process.env.MONGO_URL ?? 'mongodb://127.0.0.1:3001/meteor'

console.log("push db uri", uri);
