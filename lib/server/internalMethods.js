...
console.log("SERVER_IS_PUSH_SAVER", process.env.SERVER_IS_PUSH_SAVER, process.env.SERVER_IS_PUSH_SAVER === 'true');


if (process.env.SERVER_IS_PUSH_SAVER === 'true') {

  console.log("SERVER_IS_PUSH_SAVER registering token-insert");
